...
X_train_raw <- cbind(X_train_raw, X_train_sq)
X_test_raw  <- cbind(X_test_raw,  X_test_sq)
...
# -----------------------------
prior_gaussian <- default_prior(
  motor_UPDRS ~ age + sex + test_time + Jitter... + Shimmer + NHR + HNR + RPDE + DFA + PPE,
